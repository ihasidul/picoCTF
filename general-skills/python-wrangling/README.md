...
I was not understanding the problem statement clearly. Gone through python's man page.
### Command:
```bash 
man python 
```
              ...
              Set implementation specific option. The following options are available:
                  ...
                  -X dev: enable CPython's "development mode", introducing additional runtime
                      ...
                      only emitted when an issue is detected. Effect of the developer mode:
                         ...
                         * Install debug hooks on memory allocators: see the PyMem_SetupDebugHooks() C
              function
...
LICENSING
       ...
       Python and for a DISCLAIMER OF ALL WARRANTIES.
                                                                                             ...
                                                                                             PYTHON(1)
```
I was trying to decrypt by directly pesting the string. 
### Command:
```bash
python ende.py -d gAAAAABgUAIWjVP_Ne1VPrHlLZKpvfaifN7qlLoN7NEzOpAl55av7sPuV8wQZj9V-6oI_x4L10O8R-b9c19INaTFrlGbT6YxQeLXd2S3FQA8HmFxU9NILpJGEtVPsGpzPAmLSsRwezRX
```
### Output:
```bash
